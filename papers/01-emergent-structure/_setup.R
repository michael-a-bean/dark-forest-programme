# Shared R setup for all Quarto documents in this project
# Sourced by knitr setup chunk in each .qmd
...
# --- Data access via arrow (reads parquet natively) ---
...
query_data <- function(experiment, table, ...) {
  # For compatibility — reads parquet and applies dplyr operations
  read_experiment(experiment, table)
}

read_parquet_path <- function(path) {
